...
export default {
    ...
    computed: {
       health(){
           if (this.$store.state.healOne == 0) return this.test = true
    }
  }
}
</script>
...
.content{
    ...
    z-index: 10;
    background: url('https://thumbs.gfycat.com/NimbleUnnaturalDonkey-max-1mb.gif') no-repeat;
...
body.active .popup-inside{
    border-radius: 0;
    box-shadow: -50px 0 200px -50px red, 50px 0 200px -50px black;
}
